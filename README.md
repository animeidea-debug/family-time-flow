...
- Every visual row always represents 52 weeks. Zoom changes only the physical
  cell size, and “Locate current week” recenters the active cell without
  changing that time meaning.
